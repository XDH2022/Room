...
public interface RoomMapper {
    ...
    @Select("select room_id, room_name, room_description, create_at, update_at from t_room where room_id = #{roomId}")
    ...
    @Update("update t_room set room_name = #{room_name},room_description = #{room_description} where room_id = #{roomId}")
    int updateRoom(Room room);

    @Delete("delete from t_room where room_id = ${roomId}")
