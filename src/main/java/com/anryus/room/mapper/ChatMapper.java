...
public interface ChatMapper {
    ...
    @Insert("insert into t_chat(send_user_id,receive_id,room_id,content,create_at,update_at,delete_at) values(#{sendUserId},#{receiveId},#{roomId},#{content},#{createAt},#{updateAt},#{deleteAt})")
